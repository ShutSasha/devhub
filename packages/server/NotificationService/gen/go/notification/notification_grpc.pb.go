...
const (
	NotificationService_CreateNotification_FullMethodName = "/post.NotificationService/CreateNotification"
)
...
type NotificationServiceClient interface {
	CreateNotification(ctx context.Context, in *CreateNotificationRequest, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *notificationServiceClient) CreateNotification(ctx context.Context, in *CreateNotificationRequest, opts ...grpc.CallOption) (*Response, error) {
...
type NotificationServiceServer interface {
	CreateNotification(context.Context, *CreateNotificationRequest) (*Response, error)
...
func (UnimplementedNotificationServiceServer) CreateNotification(context.Context, *CreateNotificationRequest) (*Response, error) {
...
var NotificationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "post.NotificationService",
